...
read -d '' script <<-"_EOF_"
display dialog "A workflow that you have downloaded has implemented the Alfred Bundler to download dependencies, and it wants to use an unsigned application.
