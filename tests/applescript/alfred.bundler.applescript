...
--- THIS SHOULDN'T BE NEEDED AS NOTIFICATIONS GO THROUGH COCOADIALOG INSTEAD OF TERMINAL NOTIFIER
...
property BUNDLER_AS_LIB : "../../bundler/AlfredBundler.scpt"
...
--- THIS SHOULDN'T BE NEEDED FOR APPLESCRIPT (I think)
